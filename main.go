...
import (
	...
	infrastructurev1alpha4 "github.com/juan-lee/cluster-api-provider-hosted/api/v1alpha4"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c3741825.cluster.x-k8s.io",
	})
	if err != nil {
	...
	if err = (&controllers.HostedClusterReconciler{
		...
		Log:    ctrl.Log.WithName("controllers").WithName("HostedCluster"),
